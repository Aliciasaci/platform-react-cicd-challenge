...
export default function ProfilUser() {
    ...
    const { setUserId, userToken, setUserToken, userEmail } = useContext(AppContext);
    ...
    useEffect(() => {
        const fetchUserInfo = async () => {
            ...
            if (!userEmail || isUserInfoLoaded) {
                console.log(
                    "L'appel API n'est pas nécessaire, les infos sont déjà chargées ou l'email utilisateur est manquant."
                );
                return;
            }
    ...
    return (
        <div className='w-3/4 mb-8 h-90'>
            <div className='bg-gray-100 flex w-full justify-between'>
                    ...
                    <ul className='list-none mt-2'>
                        <li>
                            ...
                            >
                                ...
                                <span className='flex-1 ms-3 whitespace-nowrap'>{t("User_Profil_Information")}</span>
                            </a>
                        </li>
                        <li>
                            <a
                            ...
                            >
                                ...
                                <span className='flex-1 ms-3 whitespace-nowrap'>{t("Reservation_Futur")}</span>
                            </a>
                        </li>
                        <li>
                            <a
                            ...
                            >
                                ...
                                <span className='flex-1 ms-3 whitespace-nowrap'>{t("Reservation_Cancelled")}</span>
                            </a>
                        </li>
                        <li>
                            <a
                            ...
                            >
                                ...
                                <span className='flex-1 ms-3 whitespace-nowrap'>{t("Reservation_Past")}</span>
                            </a>
                        </li>
                    </ul>
                ...
                {selectedTab === "mon-compte" && <UserInformations userInfo={userInfo}></UserInformations>}
                {selectedTab === "cancelled-reservations" && <CancelledReservations></CancelledReservations>}
                {selectedTab === "reservations" && <UserReservations></UserReservations>}
                {selectedTab === "past-reservations" && <PastReservations></PastReservations>}
            </div>
        </div>
    );
}
