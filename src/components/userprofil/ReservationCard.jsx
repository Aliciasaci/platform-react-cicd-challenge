...
export default function ReservationsCard({ reservation, mode }) {
    ...
    useEffect(() => {
        const getIndisponibiliteEmploye = async () => {
            try {
                const response = await axios.get(`${import.meta.env.VITE_SERVER_URL}/employes/${idEmploye}`, {
                    headers: {
    ...
    const annulerReservation = async () => {
        let indispoList = indisponibilites.filter(
            (indispo) => indispo.jour == reservation.jour && indispo.creneau == reservation.creneau
        );
                ...
                <div className='w-full mx-3 my-2 p-2'>
                    <div className='flex flex-row justify-between items-center'>
                        ...
                        <div className='flex items-center mr-8'>
                            <div className='mr-8'>
                                <span className='text-gray-500 font-light'>{duree}mins</span>
