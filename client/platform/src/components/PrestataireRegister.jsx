                                ...
                                <div className='w-full'>
                                    <div className='w-full mb-2 mt-4 max-w-md flex-col'>
                                        <div className="flex mb-3">
                                            <ToggleSwitch className='w-32' checked={lundi} label="Lundi" onChange={setLundi} />
                                            <div className='flex w-4/5 max-w-xs justify-center'>
                                                {lundi ? <TimeRangePicker /> : <span className='text-sm text-black' >Fermé</span>}
                                            </div>
                                        </div>
                                        <div className="flex mb-3">
                                            <ToggleSwitch className='w-32' checked={mardi} label="Mardi" onChange={setMardi} />
                                            <div className='flex w-4/5 max-w-xs justify-center'>
                                                {mardi ? <TimeRangePicker /> : <span className='text-sm text-black' >Fermé</span>}
                                            </div>
                                        </div>
                                        <div className="flex mb-3">
                                            <ToggleSwitch className='w-32' checked={mercredi} label="Mercredi" onChange={setMercredi} />
                                            <div className='flex w-4/5 max-w-xs justify-center'>
                                                {mercredi ? <TimeRangePicker /> : <span className='text-sm text-black' >Fermé</span>}
                                            </div>
                                        </div>
                                        <div className="flex mb-3">
                                            <ToggleSwitch className='w-32' checked={jeudi} label="Jeudi" onChange={setJeudi} />
                                            <div className='flex w-4/5 max-w-xs justify-center'>
                                                {jeudi ? <TimeRangePicker /> : <span className='text-sm text-black' >Fermé</span>}
                                            </div>
                                        </div>
                                        <div className="flex mb-3">
                                            <ToggleSwitch className='w-32' checked={vendredi} label="Vendredi" onChange={setVendredi} />
                                            <div className='flex w-4/5 max-w-xs justify-center'>
                                                {vendredi ? <TimeRangePicker /> : <span className='text-sm text-black' >Fermé</span>}
                                            </div>
                                        </div>
                                        <div className="flex justify-between mb-3">
                                            <ToggleSwitch className='w-32' checked={samedi} label="Samedi" onChange={setSamedi} />
                                            <div className='flex w-4/5 max-w-xs justify-center'>
