                ...
                <div className="mb-6 flex">
                    <div className="w-1/2 mr-4">
                        ...
                        <input type="text"
                            ...
                            class="text-gray-900 dark:text-gray-400 placeholder-gray-700 dark:placeholder-gray-500 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-500" placeholder="sacialicia@example.fr"></input>
                    </div>

                    <div className="w-1/2 ml-4">
                        <label className="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-500">Numéro de téléphone*</label>
                        <input type="tel" class="text-gray-900 dark:text-gray-400 placeholder-gray-700 dark:placeholder-gray-500 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-500" placeholder="068765986984"></input>
                    </div>
                </div>
